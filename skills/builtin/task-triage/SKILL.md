...
2. Use `search_context` when the user asks about a named task, keyword, past reminder, deadline, plan, item to bring, tracked duty, or saved memory.
3. Use `list_tasks` only for broad current-task lists, not as a substitute for keyword search.
